'use strict';
// Banco de México exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/banxico';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MXN', { apiKey }). */
